...
Transforms raw vulnerability data into blog-style summaries for Knostic Kirin
"""
...
"""
    ...
    async def _generate_enhanced_content(self, vuln_context: str) -> dict:
        ...
        prompt = f"""
You are a cybersecurity expert writing for the Knostic Kirin vulnerability intelligence platform. Transform the following AI coding assistant vulnerability into a professional blog post suitable for developers and security professionals.
...
"""
        ...
        try:
            response = await self.client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are a cybersecurity expert specializing in AI coding assistant vulnerabilities for the Knostic Kirin platform."},
...
---
*This alert was generated by Knostic Kirin vulnerability intelligence system.*
"""
